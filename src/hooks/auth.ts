...
// Definisikan tipe untuk parameter useAuth
...
// Definisikan hook useAuth dengan TypeScript
    ...
    const login = async ({ setErrors, setStatus, ...props }: LoginProps) => {
        ...
        axios
            ...
            .then(() => {
                mutate();
                Loading.remove();
                toast.success('Login successfully, You will be redirected...', {
    ...
    const logout = async () => {
        ...
        if (!error) {
            await axios.post('/logout').then(() => {
                mutate();
                toast('Logout successfully, You will be redirected...', {
