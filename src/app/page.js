        ...
        <>
            ...
            <div className={isNavigation ? 'fixed' : 'block'}>
                ...
                <div className="py-10 text-sm text-center px-10 flex justify-center">
                    <a className="inline-flex items-center underline text-slate-950/50 hover:text-slate-950/70 dark:text-slate-100/50 dark:hover:text-slate-100/70 duration-300" href="https://github.com/ryotwell/iot.app" target="_blank" rel="noopener noreferrer">
